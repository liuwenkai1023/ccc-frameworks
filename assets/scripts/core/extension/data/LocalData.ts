...
export class LocalData {
    ...
    public LoadAllData() {
        let sGameData = <string>cc.sys.localStorage.getItem("GameData");
    ...
    public SaveAllData() {
        ...
        if (sGameDataStr != null && this._sGameData != sGameDataStr) {
            ...
            // if (CC_WECHATGAME) {
            //     let kvData: KVData = { key: "GameData", value: sGameDataStr }
            //     let object: SetUserStorageObject = {
            //         KVDataList: [kvData], success: function () {
            //             console.log("保存用户数据到微信成功:" + sGameDataStr);
            //         }
            //     };
            //     WxUtil.getInstance().setUserCloudStorage(object);
            // }
        }
    };
