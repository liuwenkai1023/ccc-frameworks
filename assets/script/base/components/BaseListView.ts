...
import BaseListAdapter from "./BaseListAdapter";

const { ccclass, property, disallowMultiple, requireComponent } = cc._decorator;

@ccclass
@disallowMultiple
export default class BaseListView extends cc.Component {
    ...
    private adapter: BaseListAdapter = null;
    ...
    public async setAdapter(adapter: BaseListAdapter) {
